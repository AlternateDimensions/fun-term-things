public class Colors {
  // Colors! Spice up your terminal-based app with some fun colored text!
  // Usage: Colors.[format] + "String goes here!" + Colors.[format] + ...
  // Example: System.out.println(Colors.CYAN + "Hello World!" + Colors.CLEAR);
  ...
  // RANDOM adds all colors into an array and then picks one. Wrote this in a terrible way so it can be remade better.
